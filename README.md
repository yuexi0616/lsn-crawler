[README.md](https://github.com/user-attachments/files/28920991/README.md)
# LSN 实验手册爬取工具

这是一个用于爬取 LSN 平台实验操作手册并转换为 Markdown 格式的 Python 工具，支持单 URL 爬取和批量 URL 爬取两种模式。
...
1. 请确保你拥有访问目标 LSN 平台的合法权限，本工具仅用于个人学习与实验用途。
